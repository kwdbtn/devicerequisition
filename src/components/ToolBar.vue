<template>
  <div class="q-pl-sm q-pb-sm">
    <q-toolbar class="bg-primary text-white shadow-2">
      <q-btn stretch flat dense icon="add" size="sm" class="q-mr-sm" @click="newRequestDialog = true">New
        <q-tooltip>New Device Request</q-tooltip>
      </q-btn>
      <q-separator dark vertical />
      <q-btn stretch size="sm" icon="ios_share" flat class="q-ml-sm q-mr-sm">Export
